...
export default function Example() {
  ...
  return (
    <section id="ourteam">
      <div className="bg-white py-24 sm:py-32 transition-colors duration-500 max-w-4xl m-auto sm:mx-10 md:mx-20 xl:m-auto">
            ...
            {visiblePeople.map((person, index) => (
              <li key={index}>
                <Image
                  ...
                  width={220}
                  height={220}
                  className="mx-auto w-45 h-45 rounded-full outline-1 -outline-offset-1 outline-white/10 object-cover border-2 border-[#68d2bc]"
                />
                <h3 className="mt-6 text-base font-semibold tracking-tight text-gray-800">
                  {person.name}
                </h3>
                  ...
                  {person.GitHubUrl && (
                    <li>
                      <Link
                        ...
                        className="text-gray-400 hover:text-[#68d2bc]"
                      >
